...
namespace HouseOfBilz
{
    public static class ObjectExtensions
    {
        public static T As<T>(this object realObject) where T : class
        {
            ...
            return DynamicWrapper.DynamicWrapper.CreateWrapper<T>(realObject);
        }
        ...
        public static T AsReal<T>(this object wrapper) where T : class
        {
            ...
            if (wrapper is DynamicWrapper.DynamicWrapper.DynamicWrapperBase)
                return (T)(wrapper as DynamicWrapper.DynamicWrapper.DynamicWrapperBase).RealObject;
...
namespace HouseOfBilz.DynamicWrapper
{
